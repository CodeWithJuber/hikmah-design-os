...
`)},s=function(){var n=parseInt(document.body.getAttribute(c)||"0",10);return isFinite(n)?n:0},S=function(){u.useEffect(function(){return document.body.setAttribute(c,(s()+1).toString()),function(){var n=s()-1;n<=0?document.body.removeAttribute(c):document.body.setAttribute(c,n.toString())}},[])},C=function(n){var r=n.noRelative,o=n.noImportant,t=n.gapMode,e=t===void 0?"margin":t;S();var i=u.useMemo(function(){return y(e)},[e]);return u.createElement(w,{styles:x(i,!r,e,o?"":"!important")})};export{C as R,g as f,d as z};
